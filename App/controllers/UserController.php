...
class UserController
{
    ...
    public function store()
    {
        ...
        if (!Validation::string($name, 2, 50)) $errors['name'] = 'Please enter a valid email address';

        if (!Validation::string($name, 2, 50)) $errors['name'] = 'Name must be between 2 and 50 characters';

        if (!Validation::string($password, 6, 50)) $errors['password'] = 'Password must be at least 6 characters';
    ...
    public function authenticate()
    {
        ...
        if (!Validation::string($password, 6, 50)) $errors['password'] = 'Please must be at least 6 characters';
